<template>
  <div style="margin-top: 24px;">
    <div style="display:flex; align-items:center; gap:12px;">
      ...
      <button v-if="streamingText" @click="copyStreaming" class="btn-sm" style="background:#f0f0f0; color:#1a1a1a; border:1px solid #ccc; border-radius:6px; cursor:pointer;">复制</button>
    </div>
